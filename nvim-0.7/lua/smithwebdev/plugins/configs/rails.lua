...
M.plugin = {
  ...
  config = function()
    ...
    nnoremap('<leader><leader>rdbr',   ':!rails db:rollback<CR>',                { desc = 'Rails DB:Setup Command'})
    ...
    nnoremap('<leader><leader>rgc',    ':Generate controller<Space>',            { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgch',   ':Generate channel<Space>',               { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgh',    ':Generate helper<Space>',                { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgj',    ':Generate job<Space>',                   { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgjb',   ':Generate jbuilder<Space>',              { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgm',    ':Generate model<Space>',                 { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgmail', ':Generate mailer<Space>',                { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgmbox', ':Generate mailbox<Space>',               { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgmig',  ':Generate migration<Space>',             { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgr',    ':Generate resource<Space>',              { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgrc',   ':Generate responders_controller<Space>', { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgs',    ':Generate scaffold<Space>',              { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgsc',   ':Generate scaffold_controller<Space>',   { desc = 'Rails Generate Command'})
    nnoremap('<leader><leader>rgt',    ':Generate task<Space>',                  { desc = 'Rails Generate Command'})
